...
const NOTIFICATIONS = [
  {
    ...
    title: 'You have new feedback from whispers',
    description: '5 unread feedback messages',
    avatar: null,
    type: 'chat_message',
  ...
  },
  {
    ...
    description: 'finished and submitted from OhioHealth riverside',
    avatar: null,
    type: 'mail',
  ...
  },
  {
    ...
    description: '"Instacart Availability" has been sent',
    avatar: null,
    type: 'order_shipped',
